...
/**
 * Handles exam-related actions, such as creating, viewing, and managing exams.
 */
class ExamController extends Controller
{
    ...
    /**
     * Store a new exam with a list of participants.
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Illuminate\Http\RedirectResponse
     */
    ...
    /**
     * Add participants to the specified exam.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \App\Models\Exam  $exam
     * @return \Illuminate\Http\RedirectResponse
     */
    public function addParticipants(Request $request, Exam $exam): RedirectResponse
    {
        $data = $request->validate([
    ...
    /**
     * Move the specified exam to the next step.
     *
     * @param  \App\Models\Exam  $exam
     * @return \Illuminate\Http\RedirectResponse
     */
    public function nextStep(Exam $exam): RedirectResponse
    {
    ...
    /**
     * Set the status of the specified exam.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \App\Models\Exam  $exam
     * @return \Illuminate\Http\RedirectResponse
     */
    public function setStatus(Request $request, Exam $exam): RedirectResponse
    {
        $data = $request->validate([
    ...
    /**
     * Set the contract visibility for the specified exam.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \App\Models\Exam  $exam
     * @return \Illuminate\Http\RedirectResponse
     */
    public function setContractVisibility(Request $request, Exam $exam): RedirectResponse
    {
        $data = $request->validate([
    ...
    /**
     * Set the current step of the specified exam.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \App\Models\Exam  $exam
     * @return \Illuminate\Http\RedirectResponse
     */
    public function setStep(Request $request, Exam $exam): RedirectResponse
    {
        $data = $request->validate([
    ...
    /**
     * Get a list of active exams with their current state.
     *
    ...
    /**
     * Set the status of a participant for a specific exam step.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \App\Models\Exam  $exam
     * @param  \App\Models\User  $participant
     * @return \Illuminate\Http\RedirectResponse
     */
    public function setParticipantStepStatus(Request $request, Exam $exam, User $participant): RedirectResponse
    {
        $data = $request->validate([
    ...
    /**
     * Update the steps for the specified exam.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \App\Models\Exam  $exam
     * @return \Illuminate\Http\RedirectResponse
