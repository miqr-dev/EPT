...
/**
 * Handles actions specific to teachers, such as dashboard views and test assignments.
 */
class TeacherController extends Controller
{
    ...
    /**
     * Assign tests to one or more participants.
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Illuminate\Http\RedirectResponse
     */
    public function assignTests(Request $request): RedirectResponse
    {
    ...
    /**
     * Remove test assignments from one or more participants.
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Illuminate\Http\RedirectResponse
     */
    public function removeTests(Request $request): RedirectResponse
    {
        $data = $request->validate([
            'participant_ids' => 'required|array',
            'test_ids' => 'required|array',
