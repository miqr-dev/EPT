...
/**
 * Calculates scores for the BRT-B test.
 */
class BrtBScorer
{
    /**
     * The questions and their correct answers for the BRT-B test.
    ...
    /**
     * Mapping of raw scores to percentile ranks.
     * @var array<int, float>
     */
    ...
    /**
     * Mapping of percentile ranks to T-scores.
    ...
    /**
     * Scores the BRT-B test.
     *
     * @param  array<string>  $answers The user's answers.
     * @param  array<int>  $times The time taken for each question.
    ...
    /**
     * Gets the T-score from a percentile rank.
     *
     * @param  float  $pr The percentile rank.
     * @return float The T-score.
     */
    ...
    /**
     * Normalizes an answer string by removing irrelevant characters.
     *
    ...
    /**
     * Parses a string into a number, handling fractions.
     *
     * @param  string  $answer The string to parse.
     * @return float|null The parsed number, or null if invalid.
     */
