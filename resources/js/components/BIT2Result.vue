...
const sexLabel = computed(() => (props.participantProfile?.sex === 'f' ? 'w' : 'm'));
      ...
      <tbody>
        <tr class="dark:bg-gray-800">
          <td v-for="code in bit2Groups" :key="code" class="px-3 py-2 text-center">
            ...
            <!-- Norm table -->
            <table class="bit2-norm-table mx-auto w-auto min-w-[760px] border text-sm">
                <thead class="bg-muted/40 dark:bg-gray-700">
                    <tr>
                        <th class="px-2 py-1 text-center font-semibold">{{ sexLabel }}</th>
                ...
                <tbody>
                    <tr
                        ...
                        :key="rIdx"
                        :class="{
                            'bit2-highlight-row': shouldHighlightRow(row.percentile),
                        }"
                    >
...
.bit2-result--pdf .bit2-norm-table {
    box-sizing: border-box;
    width: 100%;
    min-width: 0;
    overflow: hidden;
...
.bit2-result--pdf .bit2-norm-table thead tr {
    background: #f3f6fa;
}

.bit2-result--pdf .bit2-norm-table th,
.bit2-result--pdf .bit2-norm-table td {
...
.bit2-result--pdf .bit2-norm-table th:last-child,
.bit2-result--pdf .bit2-norm-table td:last-child {
    border-right: 1px solid #d1d5db;
}

.bit2-result--pdf .bit2-norm-table tbody tr:last-child td {
    border-bottom: 0;
}
...
.bit2-norm-table .bit2-score-row td,
.bit2-result--pdf .bit2-norm-table .bit2-score-row td {
    font-weight: 800;
}

.bit2-result--pdf .bit2-norm-table tbody tr:nth-child(even) {
    background: #fbfdff;
}

.bit2-norm-table tbody tr.bit2-highlight-row > td,
.bit2-result--pdf .bit2-norm-table tbody tr.bit2-highlight-row > td {
    border-bottom: 3px solid #2563eb;
}

.bit2-result--pdf .bit2-norm-table .text-red-600 {
    color: #b91c1c;
    font-weight: 800;
}

.bit2-result--pdf .bit2-norm-table .underline {
