...
<template>
    <div class="space-y-6">
        ...
        <div v-if="isLpsB" class="space-y-4 rounded-lg border bg-background p-4">
                ...
                <div class="lpsb-sheet">
                    <div class="lpsb-grid">
                        ...
                        <div class="lpsb-overlay">
                            ...
                            <svg class="lpsb-chart" :width="lpsbTopWidth" :height="lpsbGridHeight" :viewBox="`0 0 ${lpsbTopWidth} ${lpsbGridHeight}`">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-[320px] border-collapse text-sm" :style="{ width: `${lpsbTopWidth + 24}px` }">
                    <thead>
                        <tr class="bg-muted/40 text-left">
