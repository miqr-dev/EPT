    ...
    <div class="relative h-screen overflow-hidden bg-background text-black">
        ...
        <div v-if="!showTest" class="flex h-full items-center justify-center px-6">
            <div class="max-w-5xl space-y-6 rounded-2xl border border-black/20 bg-white p-8 font-serif text-base leading-relaxed shadow-sm">
                ...
                <p class="text-lg">
                    Die Lösungen tragen Sie auf Ihrem Lösungsblatt ein. Schauen wir uns dieses Blatt einmal an: Es ist bereits für jedes Blatt ein
                    kleines “Formular“ vorgedruckt, in welches jeweils nur einige Wörter oder Zahlen eingesetzt werden sollen, wie das bei derartigen
                    Vordrucken ─ etwa einer Postanweisung oder einem behördlichen Fragebogen ─ üblich ist. Jede Aufgabe wird genau beschrieben. Lesen
                    Sie sich bitte diese Schilderungen Wort für Wort langsam durch und vergleichen Sie das Gelesene bitte mit dem vorgegebenen
                    Antwort-„Formular“. Dann stellen Sie sich in Gedanken vor, wie Sie diese Arbeit in der Praxis durchführen würden und schreiben Sie
                    erst dann die Lösungen hin.
                </p>
                <p class="text-lg">
                    Schreiben Sie bitte Ihre Lösungen n u r auf das Lösungsblatt! In dieses Heft weder Notizen noch Bemerkungen oder Lösungen
                    eintragen!
                </p>
                <p class="text-lg">
                    Nebenrechnungen und Notizen bitte nur auf der Rückseite des Lösungsblattes machen. Von der Aufgabe 3 ab wird keiner ohne derartige
                    Nebenrechnungen auskommen. Jeder im Büro Beschäftigte macht sich derartige Notizen. Es ist daher auch bei diesen Aufgaben ratsam,
                    sich Notizen zu machen. Bei der Aufgabe 5 müssen unbedingt die Nebenrechnungen angegeben werden.
                </p>
                <p class="text-lg">
                    ...
                    Zeit fehlen muss. Halten Sie sich nicht zu lange bei einer Aufgabe auf. Sie haben 30 Minuten Zeit für sechs Aufgaben.
                </p>
                        ...
                        <div class="flex-1 border border-black/20 px-6 py-4">
                            <div class="space-y-4 text-center text-xl leading-relaxed">
                                <p>
                                    ...
                                    Lehrlinge für den Post-Spätdienst eingeteilt werden, so dass jeder Woche jeder Lehrling einmal Postdienst hat. Aus
                                    verkehrstechnischen Gründen können acht Lehrlinge keinen Frühdienst und neun Lehrlinge keinen Spätdienst machen.
                                </p>
                                ...
                                <p>
                                    ...
                                    Postdienst (Früh oder Spät) auf das Lösungsblatt übertragen.
                                </p>
                            </div>
                                        ...
                                        <div class="space-y-0">
                                            <div v-for="apprentice in leftNames" :key="apprentice.id" class="flex items-center gap-2">
                                                ...
                                                <span
                                                    ...
                                                    :class="{ 'text-gray-500 line-through': isAssigned(apprentice.name) }"
                                    ...
                                    >
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span
                                                ...
                                                class="min-w-0 flex-1 cursor-move"
                                                draggable="true"
                                                @dragstart="
                                                    (event) =>
        ...
        <div v-else-if="page === 2" class="flex h-full flex-col px-12 py-8 font-serif text-base">
            ...
            <div class="mt-10 flex flex-1 flex-col items-center">
                <div class="max-w-2xl space-y-6 text-center leading-relaxed">
                    ...
                    <div class="flex flex-1 gap-4">
                        <div class="flex-1 border border-black/20 px-6 py-4">
                            <div class="space-y-4 text-center text-base leading-relaxed">
                                ...
                                <p class="text-lg">
                                    Schreiben Sie bitte auf das Lösungsblatt, welche Anzahl Sie hierzu von jeder Geldsorte benötigen!
                                </p>
                            </div>
                            <!-- <div class="mt-4 text-center text-base">_____</div>
                    ...
                    <div class="flex flex-1 gap-4">
                        <div class="flex-1 border border-black/20 px-6 py-4">
                            <div class="space-y-4 text-center text-base leading-relaxed">
                                ...
                                <p class="text-xl">
                                    Schreiben Sie bitte die betreffenden Buchstaben unter die jeweilige Ordner-Nr. auf das Lösungsblatt!
                                </p>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-b border-black py-1 pl-8 text-left">
                                                <span class="tracking-[0.35em]">M</span> und <span class="tracking-[0.35em]">E</span>
                                            </td>
                    ...
                    <div class="flex flex-1 gap-4">
                        <div class="flex-1 border border-black/20 px-6 py-4">
                            <div class="space-y-4 text-center text-xl leading-relaxed">
                                ...
                                <p>
                                    Bitte auf der Rückseite Nebenrechnungen vornehmen und dann die betreffenden Tage auf dem Lösungsblatt deutlich
                                    ankreuzen.
                                </p>
                        ...
                        <div class="flex-[0.45] overflow-hidden border border-black/20 px-6 py-4">
                            <div class="flex h-full flex-col justify-between space-y-4 text-center text-xl leading-relaxed">
                                ...
                                <p>
                                    ...
                                    <span style="letter-spacing: 0.25em">b e n a c h r i c h t i g e n</span> (Namen eintragen) und wie viel Zeit Sie
                                    dafür jeweils im Einzelnen und insgesamt (ohne Rückweg) brauchen (Zeiten eintragen).
                                </p>
                                <p>
                                    Für Benachrichtigung sind jeweils (persönlich oder per Telefon) 3 Minuten zu berechnen und auf dem Lösungsblatt
                                    unter „Nachricht“ einzutragen.
                                </p>
