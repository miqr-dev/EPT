    ...
    <AppLayout>
        <div class="flex min-h-screen flex-col items-center bg-[#f6f7f9] py-4 dark:bg-gray-900">
            ...
            <div class="mt-6 flex w-full max-w-7xl flex-col gap-4 md:flex-row">
                    ...
                    >
                        ...
                        <div class="flex-1 overflow-auto">
                            <table class="w-full text-sm">
                                ...
                                <tbody>
                                    <tr
                                        v-for="user in availableRecentUsers"
                                        :key="user.id"
                                    ...
                                    >
                                        <td class="px-2 py-1 text-center">
                                            <input
                                                type="checkbox"
                                                :checked="selectedRecentUserIds.includes(user.id)"
                                    ...
                                    <tr v-if="!availableRecentUsers.length">
                                        <td colspan="3" class="py-4 text-center text-gray-400 dark:text-gray-500">No recent users found.</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <!-- Box 2: Create Exam -->
                <div class="flex flex-1 flex-col">
                    <div class="h-full rounded-xl border border-gray-100 bg-white p-4 shadow dark:border-gray-700 dark:bg-gray-800">
                        <h2 class="mb-3 text-base font-semibold text-gray-800 dark:text-gray-200">Create New Exam</h2>
                        <div v-if="!showCreateExamForm">
                            <button
                                @click="showCreateExamForm = true"
                        ...
                        <div v-else>
                            ...
                            <div class="flex items-center gap-4">
                                <button
                                    @click="addSelectedUsersToStage"
                                    :disabled="!selectedRecentUserIds.length"
                            ...
                            <div class="mt-4 flex justify-end gap-2">
                                ...
                                <button
                                    @click="saveExam"
                                    :disabled="!newExamTitle || !stagedUserIds.length"
