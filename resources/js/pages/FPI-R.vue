...
import { FPI_R_QUESTIONS } from '@/pages/Questions/FpiRQuestions';
...
if (props.pausedTestResult) {
  ...
  FPI_R_QUESTIONS.forEach((q) => (answers.value[q.number] = null));
}
...
function getAnswers() {
  return {
    answers: FPI_R_QUESTIONS.map((q) => ({ number: q.number, answer: answers.value[q.number] })),
  };
}
        ...
        <div class="flex min-h-[600px] flex-1 gap-4 rounded-xl bg-muted/20 p-4">
            <div class="flex flex-1 flex-col gap-4">
                <div v-if="!showTest" class="flex h-full flex-col items-center justify-center">
                    <h2 class="mb-4 text-2xl font-bold">FPI-R</h2>
                            ...
                            <tr v-for="q in questions" :key="q.number" :class="{ 'bg-gray-50 dark:bg-gray-700': answers[q.number] === null }">
                                ...
                                <td class="px-2 text-center align-top pt-1 border-b-2 border-gray-200 dark:border-gray-700">
                                    <label class="w-8 h-8 relative flex items-center justify-center border border-gray-400 cursor-pointer">
                                        ...
                                        <span class="text-sm">Stimmt</span>
                                ...
                                <td class="px-2 text-center align-top pt-1 border-b-2 border-gray-200 dark:border-gray-700">
                                    <label class="w-8 h-8 relative flex items-center justify-center border border-gray-400 cursor-pointer">
                                        ...
                                        <span class="text-sm">Stimmt nicht</span>
